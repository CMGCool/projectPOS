                ...
                <div class="col-md-4 col-md-offset-4">
                    <form action="" method="post">
                        ...
                        <div class="form-group <?=form_error('password')?'has-error':null ?>" >
                            <label>Password </label> <small> Abaikan Apabila Tidak Terdapat Perubahan Password </small>
                        ...
                        <div class="form-group">
                            <label>Address</label>
                            <textarea type="text" name="address" class="form-control"><?=$this->input->post('address') ? $this->input->post('address') : $row->address ?></textarea>
                            <?=form_error('address')?>
                        </div>
